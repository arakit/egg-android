...
public class HttpHeaderParser {
    ...
    public static Cache.Entry parseCacheHeaders(NetworkResponse response) {
        ...
        for(Pair<String, String> p : headers){
            if(p.first.equalsIgnoreCase("Date")){
        ...
        headerValue = null;
        for(Pair<String, String> p : headers){
            if(p.first.equalsIgnoreCase("Cache-Control")){
                headerValue = p.second;
                break;
            }
        }
        ...
        headerValue = null;
        for(Pair<String, String> p : headers){
            if(p.first.equalsIgnoreCase("Expires")){
                headerValue = p.second;
                break;
            }
        }
        ...
        serverEtag = null;
        for(Pair<String, String> p : headers){
            if(p.first.equalsIgnoreCase("ETag")){
                serverEtag = p.second;
                break;
            }
        }
    ...
    public static String parseCharset(List<Pair<String, String>> headers) {
        ...
        for(Pair<String, String> pair : headers){
            if(pair.first.equalsIgnoreCase(HTTP.CONTENT_TYPE)){
